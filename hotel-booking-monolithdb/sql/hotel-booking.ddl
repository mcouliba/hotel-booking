...
CREATE TABLE "COUNTRY" (
	...
	"ISO_COUNTRY_CODE" character varying(256) NOT NULL,
	"ISO_CURRENCY_CODE" character varying(256) NOT NULL,
	PRIMARY KEY ( "ID" )
);
...
CREATE TABLE "CUSTOMER" (
	...
	"REWARDS_ID" character varying(256) NOT NULL,
...
CREATE TABLE "PAYMENT_INFO" (
	...
	"CREDIT_CARD_TYPE" character varying(256) NOT NULL,
...
CREATE TABLE "ROOM" (
	...
	"ROOM_NUMBER" character varying(256) NOT NULL,
	"FLOOR" INTEGER NOT NULL,
	"RATE" DECIMAL(7,2) NOT NULL,
	PRIMARY KEY ( "ID" ),
	CONSTRAINT "HOTEL_FK" FOREIGN KEY ( "HOTEL_ID" ) REFERENCES "HOTEL" ( "ID" ),
	CONSTRAINT "ROOM_CONFIG_FK" FOREIGN KEY ( "ROOM_CONFIG_ID" ) REFERENCES "ROOM_CONFIG" ( "ID" )
);
